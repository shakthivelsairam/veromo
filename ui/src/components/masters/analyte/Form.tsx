    ...
    <React.Fragment>
      <Dialog fullWidth={true} maxWidth={false} open={props.showForm}>
        <DialogTitle className={custstyle.addeditmenu}>
          {props.editForm ? "Edit" : "Add"} Analyte
        </DialogTitle>
            ...
            <Grid container spacing={3} style={{ marginTop: 5 }}>
              ...
              <Grid item xs={3}>
                <Autocomplete
                  ...
                  sx={{ width: 250 }}
                  renderInput={(params) => (
                    <TextField {...params} label="Sample" variant="standard" />
                  )}
            ...
            <Grid container spacing={3} style={{ marginTop: 5 }}>
              ...
              <Grid item xs={3}>
                <Autocomplete
                  ...
                  sx={{ width: 250 }}
                  renderInput={(params) => (
                    <TextField {...params} label="LOINC" variant="standard" />
                  )}
              ...
              <Table size="small">
                ...
                <TableBody>
                  {associatedTestData.map((row: any) => (
                    <StyledTableRow key={row.id}>
                      <StyledTableCell>{row.test_code}</StyledTableCell>
