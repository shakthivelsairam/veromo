...
import ClientTariffMappingForm from "./Form";
...
export default function ClientTariffMapping(){
  ...
  useEffect(()=>{
    const rows = [
      ...
      {id:2, client_name: "Client 2", tariff_name: "L2L Rate", valid_from: '2020-10-21 12:00 AM', valid_to: "2021-10-21 12:00 AM", status: "Inactive" },
    ];
    setData(rows)
  }, [])
      ...
      <div>
        ...
        <Grid container spacing={2}>
            ...
            <Dialog fullWidth={true} maxWidth={false} open={showForm}>
              <DialogTitle className={custstyle.addeditmenu}>{editForm ? "Edit" : "Add"} Client Tariff</DialogTitle>
              ...
              <TableBody>
                {data.map((row:any) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell>{row.tariff_name}</StyledTableCell>
