...
import { Tabs, Tab, Box, Grid, TextField, FormControlLabel,Checkbox,Button,Typography,MenuItem,Select,InputLabel,FormControl,Autocomplete, TableRow, Table, TableHead, TableBody } from '@mui/material';
      ...
      <TabPanel value={value} index={0}>
        ...
        <Grid item xs={3}>
          ...
          <Grid item xs={6}>
            ...
            <Grid container spacing={5} style={{ paddingTop:10}}>
            <Grid item xs={3}>
            <FormControlLabel control={<Checkbox color="secondary" name="active" value="yes" />} label="Threshold amount in value" />
            </Grid>
            <Grid item xs={3}>
            <TextField
            ...
            <Grid item xs={3}>
            <FormControlLabel control={<Checkbox color="secondary" name="active" value="yes" />} label="Co-Payment" />
            </Grid>
            <Grid item xs={3}>
            <FormControlLabel control={<Checkbox color="secondary" name="active" value="yes" />} label="MappedRate" />
            </Grid>
            <Grid item xs={3}>
            <FormControlLabel control={<Checkbox color="secondary" name="active" value="yes" />} label="MRP" />
            </Grid>
            </Grid>

            <Grid container spacing={3} style={{marginTop: 5}}>
            <Grid item xs={3}>
            <FormControlLabel control={<Checkbox color="secondary" name="active" value="yes" />} label="FTP" />
            </Grid>
            <Grid item xs={3}>
            <FormControl variant="standard">
              <Autocomplete
              ...
              sx={{ width: 200,marginRight: 2}}
              renderInput={(params) => <TextField {...params} label="InvoiceCycle" variant="standard" />}
              value={invoicecycle}
            />
           </FormControl>
           </Grid> 
      ...
      {/* --------------Address Tab changes------------ */}
          ...
          <Grid container spacing={5} style={{ paddingTop: 10 }}>
            ...
            <FormControl variant="standard">
              ...
              sx={{ width: 200,marginRight: 2}}
              renderInput={(params) => <TextField {...params} label="AddressType" variant="standard" />}
              value={addrtype}
            />
           </FormControl>
           </Grid>           
            ...
            <Table size="small">
              ...
              {data && data.map((row:any) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell align="center"><Button size="small">
                    <DeleteIcon fontSize="small"></DeleteIcon></Button></StyledTableCell>
                  </StyledTableRow>
                )) }
              </TableBody>
            </Table>
    ...
    {/* --------------Notification Tab changes------------ */}
          ...
          <Grid item xs={3}>
            <FormControl variant="standard">
              ...
              options={optNotType}
              sx={{ width: 200,marginRight: 2}}
              renderInput={(params) => <TextField {...params} label="Notification Type" variant="standard" />}
              value={notification}
           />
           </FormControl>
           </Grid>
          <Grid item xs={3}>
            <FormControl variant="standard">
              ...
              sx={{ width: 200,marginRight: 2}}
              renderInput={(params) => <TextField {...params} label="Action Type" variant="standard" />}
              value={actiontype}
            />
           </FormControl>
           </Grid>
          ...
          <Grid container spacing={3} style={{ marginTop: 5 }}>
            <Grid item xs={5} style={{ textAlign: "right" }}>
              <Button variant="contained" color="success" onClick={NotificationRefTable}>Add</Button>
            </Grid>
            <Grid item xs={5} style={{ textAlign: "left" }}>
              <Button variant="contained" style={{ backgroundColor: "lightgray", color: "black" }}>Cancel</Button>
            </Grid>
          ...
          <div style={{ width: '100%', marginTop: 5 }}>
            <Table size="small">
              ...
              <TableBody>
              {notifydata && notifydata.map((notifyrow:any) => (
