...
export default function SampleMaster(){
  ...
  useEffect(()=>{
    const rows = [
      {id:1, type: "Email", ipaddress: "192.128.0.1", username: "EMAILUSER", password:"*********" },
      {id:2, type: "Email", ipaddress: "192.224.0.1", username: "POP2USER", password:"*********" },
      {id:3, type: "SMS", ipaddress: "109.224.0.1", username: "SMSINTEG", password:"*********" },
    ];
    setData(rows)
  }, [])
      ...
      <div>
        ...
        <Grid container spacing={2}>
            ...
            <Dialog fullWidth={true} maxWidth={false} open={showForm}>
              <DialogTitle className={custstyle.addeditmenu}>{editForm ? "Edit" : "Add"} Email & SMS Gateway</DialogTitle>
