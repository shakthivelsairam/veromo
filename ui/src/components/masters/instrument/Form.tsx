    ...
    return(
        <React.Fragment>
           <Dialog fullWidth={true} maxWidth={false} open={props.showFormMetadata}>
              <DialogTitle className={custstyle.addeditmenu}>{props.metaEditForm ? "Edit" : "Add"} Instrument Type</DialogTitle>
        ...
        <Autocomplete
          ...
          <Autocomplete
              ...
              sx={{ width: 300 }}
              renderInput={(params) => <TextField {...params} label="Service Group" variant="standard" />}
