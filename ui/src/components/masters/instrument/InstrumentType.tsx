...
import { Dialog, DialogActions, DialogContent, DialogTitle, useMediaQuery,Autocomplete } from '@mui/material';
    ...
    return(
        <React.Fragment>
          <Dialog fullWidth={true} maxWidth={false} open={props.showForm}>
              <DialogTitle className={custstyle.addeditmenu}>{props.editForm ? "Edit" : "Add"} Instrument Type</DialogTitle>
          ...
          <Grid item xs={1}>
          <Button variant="contained" style={{backgroundColor:"lightgray", color:"black"}} onClick={props.togglePage}>Close</Button>
          <br/><br/>
          </Grid>
          </Grid>
              </Dialog>
