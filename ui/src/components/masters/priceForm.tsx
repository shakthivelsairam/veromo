        ...
        <Grid item xs={true} style={{ marginLeft: 20 }}>
          <FormControl variant="standard">
            ...
            >
              ...
              <MenuItem key="1" value="Q-Doc">
                Q-Doc
              </MenuItem>
              <MenuItem key="2" value="Sai Care">
                Sai Care
              </MenuItem>
              <MenuItem key="3" value="Apollo">
                Apollo
              </MenuItem>
              <MenuItem key="4" value="Fortis">
                Fortis
              </MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl variant="standard">
            <Autocomplete
              ...
              sx={{ width: 250 }}
              renderInput={(params) => (
                <TextField {...params} label="Tariff Name" variant="standard" />
              )}
            />
          </FormControl>
