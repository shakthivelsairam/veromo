...
export default function DepartmentList(){
  ...
  // 
  const rows = [
    {id: 1, org: "Q-Doc", tariffNType: 'General', tariffSType: "Vendor", tariffName: "General", priceType: "Cash", appliedTo: "Un-Mapped Services" },
    {id: 2, org: "Sai Care", tariffNType: 'Miss', tariffSType: "Agreement", tariffName: "Special", priceType: "Cash,Card", appliedTo: "Mapped Services" },
