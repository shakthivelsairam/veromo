              ...
              <TableBody>
                {data && data.map((row:any) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell align="center"><Button size="small" onClick={()=>pageType(true, row.id)}><EditIcon fontSize="small"></EditIcon></Button><Button size="small" onClick={()=>removeTariffCard(row.id)}><DeleteIcon fontSize="small"></DeleteIcon></Button></StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
            </Table>
