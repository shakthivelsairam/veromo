...
export default function TariffMaster(){
  ...
  useEffect(()=>{
    const rows = [
      {id:1, name: "Pari",username: "PARI", roles:"Technician,Administrator,Lab Manager", locked: "No", history: "View" },
      {id:2, name: "Dhanasekaran",username: "Dhana", roles:"Technician,Administrator,Lab Manager,Credit Controller,Center Manager", locked: "No", history: "View" },
    ];
    setData(rows)
  }, [])
