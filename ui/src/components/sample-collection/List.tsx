...
export default function SampleCollectionList(){
  ...
  useEffect(()=>{
    const rows = [
      {id: 1, lab_number: "180304804", patient_name: 'Mr.Vijay', patient_details:"M | 32 Y", ref_doctor: "Self", bill_date: "28-Nov-2021 12:17 PM" },
    ...
    return(
      <div>
        {showForm &&
        <SampleCollectionForm togglePage={togglePage}/>
        }
        {showList &&
        <React.Fragment>
